...
export const Hero = () => {
  ...
  return <section className="relative py-16 md:py-24 flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 text-center relative z-10">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-6xl font-bold mb-4 bg-clip-text text-transparent bg-gradient-primary">Einstieg in Prompting !</h1>
